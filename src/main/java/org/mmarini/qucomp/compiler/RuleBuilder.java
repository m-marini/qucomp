...
abstract class RuleBuilder {
     ...
     */
    void bind(Function<String, SyntaxRule> binder) throws ParseException {
    }
    ...
    public static abstract class NonTerminalRuleBuilder extends RuleBuilder {
        ...
        void bind(Function<String, SyntaxRule> binder) throws ParseException {
            ...
            if (rule == null) {
                throw new ParseException("Missing rule " + this);
            }
            ...
            if (rule instanceof SyntaxRule.NonTerminalRule nonTerm) {
                ...
                throw new ParseException(rule + " is not a non terminal rule");
            }
        }
    }
}
